...
Obstacles to success (gotta keep it positive)
...
Restaking strips the token startups of crucial value capture/ business model[6]
...
final counterpoint — value is unlimited
